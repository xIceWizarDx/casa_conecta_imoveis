        ...
        <div className="mb-16">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {associations?.map((assoc, index) => (
              <div key={index} className=" rounded-xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            {recognitions?.map((recognition, index) => (
              <div key={index} className=" rounded-xl p-6 flex items-start space-x-4">
